    ...
    <footer className="bg-blue-900 text-white pt-12 mt-3">
      <div className="container mx-auto flex flex-wrap justify-between mb-10">
        <div className="w-full md:w-2/5">
          ...
          <p>Địa chỉ: 279 Nguyễn Tri Phương, P. 5, Q. 10, Thành phố Hồ Chí Minh</p>
          <p>Điện thoại: 0123 456 789</p>
          <p>Email: events.ueh@gmail.com</p>
        </div>
        ...
        <div className="container">
            <div className="row g-0">
                <div className="col-md-6 text-center text-md-start">
                    <p className="mb-md-0">&copy; <a className="text-white border-bottom" href="#">events.ueh@gmail.com</a>. Bảo lưu mọi quyền.</p>
                </div>
                <div className="col-md-6 text-center text-md-end">
                    <p className="mb-0">Thiết Kế Bởi <a className="text-white border-bottom" href="#">Events UEH</a><br/>              
                    </p>
                </div>
            </div>
        </div>
